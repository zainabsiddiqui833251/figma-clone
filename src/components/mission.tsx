        ...
        <section className='w-[1100px] m-auto mt-[10%] '>
            ...
            <div className='flex justify-between'>
                <div className='w-[413px] h-[144px] flex items-center justify-center mt-7'>
                    ...
                    <p className='w-[279px] text-[#333333] font-normal text-[22px] ml-7 '>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed efficitur, lectus et facilisis placerat.</p>
                </div>
                <div className='w-[570px] h-[144px] flex items-center justify-center mt-7'>
                    ...
                    <p className='w-[420px] text-[#333333] font-normal text-[22px] ml-7'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed efficitur, lectus et facilisis placerat, magna mauris porttitor tortor, a auctor est felis ut nisl.</p>
                </div>
            </div>
        </section>
    )
